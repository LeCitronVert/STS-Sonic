package sonicthehedgemod.sonic;
...
import static sonicthehedgemod.SonicTheHedgemod.characterPath;
...
public class Sonic extends CustomPlayer {
    ...
    //Strings
    private static final String ID = makeID("Sonic"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Enums {
        ...
        @SpireEnum
        public static AbstractPlayer.PlayerClass SONIC_THE_HEDGEHOG;
        @SpireEnum(name = "SONIC_THE_HEDGEHOG_MAIN_COLOUR") // These two MUST match. Change it to something unique for your character.
        public static AbstractCard.CardColor CARD_COLOR;
        @SpireEnum(name = "SONIC_THE_HEDGEHOG_MAIN_COLOUR") @SuppressWarnings("unused")
    ...
    private final Color cardRenderColor = SonicTheHedgemod.cardColor.cpy(); //Used for some vfx on moving cards (sometimes) (maybe)
    private final Color cardTrailColor = SonicTheHedgemod.cardColor.cpy(); //Used for card trail vfx during gameplay.
    private final Color slashAttackColor = SonicTheHedgemod.cardColor.cpy(); //Used for a screen tint effect when you attack the heart.
    @Override
    ...
    public List<CutscenePanel> getCutscenePanels() {
        ...
        panels.add(new CutscenePanel(SonicTheHedgemod.endingPath("EndingSlice_1.png"), "ATTACK_DAGGER_2"));
        panels.add(new CutscenePanel(SonicTheHedgemod.endingPath(("EndingSlice_2.png"))));
        panels.add(new CutscenePanel(SonicTheHedgemod.endingPath(("EndingSlice_3.png"))));
